...
insert into auth.users (id, email) values
  ('00000000-0000-0000-0000-0000000100ff', 'bootstrap@limite-email.pt');

insert into public.organizacoes (id, nome, codigo) values
  ('00000000-0000-0000-0000-000000010000', 'Org Limite Email', 'limite-email-i');

insert into auth.users (id, email) values
  ('00000000-0000-0000-0000-000000010a01', 'admin@limite-email.pt'),
  ('00000000-0000-0000-0000-000000010a02', 'destino@limite-email.pt');
...
select is(
  (select status from public.notification_queue where notification_id = '00000000-0000-0000-0000-000000f10001' and status = 'pending'),
  'pending',
...
select is(
  (select count(*)::int from public.notifications where org_id = '00000000-0000-0000-0000-000000010000' and destinatario_user_id = '00000000-0000-0000-0000-000000010a01' and template_codigo = 'sistema.limite_email_atingido'),
  1,
  'admin recebe um aviso interno quando o limite diário é atingido'
);

select is(
  (select count(*)::int from public.notificacoes where destinatario_id = '00000000-0000-0000-0000-000000010a01' and tipo = 'sistema_limite_email_atingido'),
  1,
...
select is(
  (select count(*)::int from public.notifications where org_id = '00000000-0000-0000-0000-000000010000' and template_codigo = 'sistema.limite_email_atingido'),
  1,
...
insert into public.organizacoes (id, nome, codigo) values
  ('00000000-0000-0000-0000-000000010001', 'Org Sem Limite', 'sem-limite-i');

insert into public.notification_queue (notification_id, org_id, canal, destinatario, template_codigo, status, created_at)
values (
  '00000000-0000-0000-0000-000000f10001', '00000000-0000-0000-0000-000000010001',
