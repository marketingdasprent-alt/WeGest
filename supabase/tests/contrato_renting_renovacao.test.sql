...
insert into public.viaturas (id, org_id, matricula, marca, modelo) values
  ('00000000-0000-0000-0000-000000v1e0e1', '00000000-0000-0000-0000-0000000e0000', 'RR-11-RR', 'Toyota', 'Corolla'),
  ('00000000-0000-0000-0000-000000v2e0e2', '00000000-0000-0000-0000-0000000e0000', 'RR-22-RR', 'Toyota', 'Corolla'),
  ('00000000-0000-0000-0000-000000v3e0e3', '00000000-0000-0000-0000-0000000e0000', 'RR-33-RR', 'Toyota', 'Corolla'),
  ('00000000-0000-0000-0000-000000v4e0e4', '00000000-0000-0000-0000-0000000e0000', 'RR-44-RR', 'Toyota', 'Corolla');
...
insert into public.contratos_renting (id, org_id, cliente_id, viatura_id, matricula, data_inicio, data_fim, estado_operacional, regime, is_longa_duracao) values
  ('00000000-0000-0000-0000-000000ct1e01', '00000000-0000-0000-0000-0000000e0000', '00000000-0000-0000-0000-0000000e0c01', '00000000-0000-0000-0000-000000v1e0e1', 'RR-11-RR', now() - interval '60 days', now() - interval '1 day', 'em_curso', 'rent_a_car', true);

-- C2: rent_a_car, data_fim daqui a 100 dias — NÃO deve emitir (ainda não chegou o prazo).
insert into public.contratos_renting (id, org_id, cliente_id, viatura_id, matricula, data_inicio, data_fim, estado_operacional, regime, is_longa_duracao) values
  ('00000000-0000-0000-0000-000000ct2e02', '00000000-0000-0000-0000-0000000e0000', '00000000-0000-0000-0000-0000000e0c01', '00000000-0000-0000-0000-000000v2e0e2', 'RR-22-RR', now() - interval '10 days', now() + interval '100 days', 'em_curso', 'rent_a_car', true);
...
insert into public.contratos_renting (id, org_id, cliente_id, viatura_id, matricula, data_inicio, data_fim, estado_operacional, regime, is_longa_duracao, substituido_em) values
  ('00000000-0000-0000-0000-000000ct3e03', '00000000-0000-0000-0000-0000000e0000', '00000000-0000-0000-0000-0000000e0c01', '00000000-0000-0000-0000-000000v3e0e3', 'RR-33-RR', now() - interval '60 days', now() - interval '1 day', 'em_curso', 'rent_a_car', true, now());
...
insert into public.contratos_renting (id, org_id, cliente_id, viatura_id, matricula, data_inicio, data_fim, estado_operacional, regime, is_longa_duracao) values
  ('00000000-0000-0000-0000-000000ct4e04', '00000000-0000-0000-0000-0000000e0000', '00000000-0000-0000-0000-0000000e0c01', '00000000-0000-0000-0000-000000v4e0e4', 'RR-44-RR', now() - interval '40 days', null, 'em_curso', 'tvde', true);
...
select is(
  (select count(*)::int from public.domain_events where entity_id = '00000000-0000-0000-0000-000000ct1e01' and event_type = 'contrato_renting.renovacao_proxima'),
  1,
...
select is(
  (select count(*)::int from public.domain_events where entity_id = '00000000-0000-0000-0000-000000ct2e02' and event_type = 'contrato_renting.renovacao_proxima'),
  0,
...
select is(
  (select count(*)::int from public.domain_events where entity_id = '00000000-0000-0000-0000-000000ct3e03' and event_type = 'contrato_renting.renovacao_proxima'),
  0,
...
select is(
  (select (payload->>'prazo')::date from public.domain_events where entity_id = '00000000-0000-0000-0000-000000ct4e04' and event_type = 'contrato_renting.renovacao_proxima'),
  (select public.proxima_data_renovacao(c.data_inicio, c.renovacao_opcao::text, c.renovacao_intervalo_dias)::date from public.contratos_renting c where c.id = '00000000-0000-0000-0000-000000ct4e04'),
...
select is(
  (
    ...
    where n.destinatario_user_id = '00000000-0000-0000-0000-0000000e0a01'
      and r.entity_id = '00000000-0000-0000-0000-000000ct1e01'
  ),
  1,
