...
insert into public.organizacoes (id, nome, codigo) values
  ('00000000-0000-0000-0000-000000kk0000', 'Org IUC', 'iuc-kk');

insert into auth.users (id, email) values
  ('00000000-0000-0000-0000-000000kk0001', 'admin@iuc-kk.pt');

insert into public.user_organizacoes (user_id, org_id, is_admin) values
  ('00000000-0000-0000-0000-000000kk0001', '00000000-0000-0000-0000-000000kk0000', true);
...
insert into public.viaturas (id, org_id, matricula, marca, modelo, data_matricula) values
  ('00000000-0000-0000-0000-000000kk0010', '00000000-0000-0000-0000-000000kk0000', 'IU-00-CA', 'Renault', 'Clio',
   (current_date + 10) - interval '3 years');

-- Viatura B: aniversário da matrícula daqui a 60 dias — NÃO deve disparar.
insert into public.viaturas (id, org_id, matricula, marca, modelo, data_matricula) values
  ('00000000-0000-0000-0000-000000kk0011', '00000000-0000-0000-0000-000000kk0000', 'IU-00-CB', 'Renault', 'Clio',
...
select is(
  (select count(*)::int from public.domain_events where entity_id = '00000000-0000-0000-0000-000000kk0010' and event_type = 'viatura.iuc_a_pagar'),
  1,
...
select is(
  (select count(*)::int from public.domain_events where entity_id = '00000000-0000-0000-0000-000000kk0011' and event_type = 'viatura.iuc_a_pagar'),
  0,
