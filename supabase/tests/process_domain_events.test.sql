...
select ok(
  (select processed_at is not null from public.domain_events where id = '00000000-0000-0000-0000-000000e81e01'),
  'evento sem condições a bloquear fica marcado como processado'
);

-- 2. Cria-se exatamente um automation_run ligado a este evento.
select is(
  (select count(*)::int from public.automation_runs where trigger_event_id = '00000000-0000-0000-0000-000000e81e01'),
  1,
...
select is(
  (select count(*)::int from public.automation_runs where trigger_event_id = '00000000-0000-0000-0000-000000e82e01'),
  1,
...
select is(
  (select count(*)::int from public.automation_runs where trigger_event_id = '00000000-0000-0000-0000-000000e83e01'),
  0,
...
select is(
  (select count(*)::int from public.automation_logs where rule_id = '00000000-0000-0000-0000-00000046b001' and evento = 'condicao_nao_satisfeita'),
  1,
...
select ok(
  (select processed_at is not null from public.domain_events where id = '00000000-0000-0000-0000-000000e83e01'),
...
select is(
  (select count(*)::int from public.automation_logs where rule_id = '00000000-0000-0000-0000-00000046c001' and evento = 'ignorada_cooldown'),
  1,
...
select ok(
  (select processed_at is not null from public.domain_events where id = '00000000-0000-0000-0000-000000e85e01'),
...
select ok(
  (select processed_at is not null from public.domain_events where id = '00000000-0000-0000-0000-000000e86e01'),
