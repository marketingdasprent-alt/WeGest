...
insert into public.organizacoes (id, nome, codigo) values
  ('00000000-0000-0000-0000-0000000g0000', 'Org Contrato Criado', 'contrato-criado-g');

insert into auth.users (id, email) values
  ('00000000-0000-0000-0000-0000000g0001', 'admin@contrato-criado.pt');

insert into public.user_organizacoes (user_id, org_id, is_admin) values
  ('00000000-0000-0000-0000-0000000g0001', '00000000-0000-0000-0000-0000000g0000', true);

insert into public.viaturas (id, org_id, matricula, marca, modelo) values
  ('00000000-0000-0000-0000-0000000g0010', '00000000-0000-0000-0000-0000000g0000', 'GC-00-RI', 'Fiat', 'Punto');

insert into public.clientes (id, org_id, codigo, nome) values
  ('00000000-0000-0000-0000-0000000g0020', '00000000-0000-0000-0000-0000000g0000', 990001, 'Cliente Teste G');

insert into public.reservas (id, org_id, codigo, data_inicio, viatura_id, cliente_id) values
  ('00000000-0000-0000-0000-0000000g0030', '00000000-0000-0000-0000-0000000g0000', 990001, now(),
   '00000000-0000-0000-0000-0000000g0010', '00000000-0000-0000-0000-0000000g0020');
...
values (
  '00000000-0000-0000-0000-0000000g0040', '00000000-0000-0000-0000-0000000g0000', 990001,
  '00000000-0000-0000-0000-0000000g0030', '00000000-0000-0000-0000-0000000g0020', '00000000-0000-0000-0000-0000000g0010',
  'GC-00-RI', now(), 35, '00000000-0000-0000-0000-0000000g0001'
);

-- 1. Contrato novo publica o domain_event.
select is(
  (select count(*)::int from public.domain_events where entity_id = '00000000-0000-0000-0000-0000000g0040' and event_type = 'contrato_renting.criado'),
  1,
...
select is(
  (select count(*)::int from public.notifications where destinatario_user_id = '00000000-0000-0000-0000-0000000g0001' and template_codigo = 'contrato_renting.criado'),
  1,
...
values (
  '00000000-0000-0000-0000-0000000g0041', '00000000-0000-0000-0000-0000000g0000', 990002,
  '00000000-0000-0000-0000-0000000g0030', '00000000-0000-0000-0000-0000000g0020', '00000000-0000-0000-0000-0000000g0010',
  'GC-00-RI', now(), 35, '00000000-0000-0000-0000-0000000g0001',
  '00000000-0000-0000-0000-0000000g0040', 2
);

-- 3. Nova versão de um contrato existente NÃO publica contrato_renting.criado.
select is(
  (select count(*)::int from public.domain_events where entity_id = '00000000-0000-0000-0000-0000000g0041' and event_type = 'contrato_renting.criado'),
  0,
