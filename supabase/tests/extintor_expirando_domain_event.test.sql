...
insert into public.organizacoes (id, nome, codigo) values
  ('00000000-0000-0000-0000-000000jj0000', 'Org Extintor', 'extintor-jj');

insert into auth.users (id, email) values
  ('00000000-0000-0000-0000-000000jj0001', 'admin@extintor-jj.pt');

insert into public.user_organizacoes (user_id, org_id, is_admin) values
  ('00000000-0000-0000-0000-000000jj0001', '00000000-0000-0000-0000-000000jj0000', true);
...
insert into public.viaturas (id, org_id, matricula, marca, modelo, extintor_validade) values
  ('00000000-0000-0000-0000-000000jj0010', '00000000-0000-0000-0000-000000jj0000', 'EX-00-AA', 'Peugeot', '208', current_date + 10);

-- Viatura B: extintor válido por mais 60 dias — NÃO deve disparar.
insert into public.viaturas (id, org_id, matricula, marca, modelo, extintor_validade) values
  ('00000000-0000-0000-0000-000000jj0011', '00000000-0000-0000-0000-000000jj0000', 'EX-00-BB', 'Peugeot', '208', current_date + 60);

select public.emit_expiry_events();

-- 1. Extintor a expirar em 10 dias publica o domain_event.
select is(
  (select count(*)::int from public.domain_events where entity_id = '00000000-0000-0000-0000-000000jj0010' and event_type = 'viatura.extintor_expirando'),
  1,
...
select is(
  (select count(*)::int from public.domain_events where entity_id = '00000000-0000-0000-0000-000000jj0011' and event_type = 'viatura.extintor_expirando'),
  0,
