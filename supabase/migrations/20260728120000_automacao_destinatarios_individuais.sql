-- Acrescenta um segundo nível de granularidade à estratégia 'cargo':
-- em vez de notificar sempre TODOS os utilizadores dos cargos escolhidos,
-- a regra pode agora escolher pessoas específicas de dentro desses
-- cargos. destinatarios_modo default 'grupo' — nenhuma regra existente
-- tem este campo, comportamento atual inalterado sem migração de dados.
