...
export const CartaConducaoSection: React.FC<CartaConducaoSectionProps> = ({
  ...
  setDocumentoTipo, setDocumentoNumero, setDocumentoValidade, setDocumentoFicheiroUrl, setDocumentoIdentificacaoVersoUrl,
  cartaConducao, cartaCategorias, cartaValidade, cartaFicheiroUrl, cartaConducaoVersoUrl,
  setCartaConducao, setCartaCategorias, setCartaValidade, setCartaFicheiroUrl, setCartaConducaoVersoUrl,
  fieldErrors, setFieldError, clearFieldError, onUploadToDb,
}) => {
  ...
  return (
    <>
      ...
      <Card className="border-border overflow-hidden">
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            <Select
              value={documentoTipo}
              onValueChange={(v) => { setDocumentoTipo(v); clearFieldError('documentoTipo'); clearFieldError('documentoNumero'); }}
            >
          ...
          <div className="space-y-2">
            <Label htmlFor="documentoNumero">Número do Documento <span className="text-red-500">*</span></Label>
            <Input
              id="documentoNumero" value={documentoNumero}
              onChange={(e) => { setDocumentoNumero(e.target.value.toUpperCase()); clearFieldError('documentoNumero'); }}
              onBlur={() => {
          ...
          <div className="space-y-2">
            <Label htmlFor="documentoValidade">Data de Validade <span className="text-red-500">*</span></Label>
            <Input
              id="documentoValidade" type="date" value={documentoValidade}
              onChange={(e) => { setDocumentoValidade(e.target.value); clearFieldError('documentoValidade'); }}
          ...
          <div className="space-y-2 sm:col-span-2">
            <Label>Documento de Identificação <span className="text-red-500">*</span></Label>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <span className="text-xs text-muted-foreground block mb-1">Frente</span>
                <DocumentUploader
                  folder="documento-identificacao" currentUrl={documentoFicheiroUrl}
                  onUpload={(url) => { setDocumentoFicheiroUrl(url); clearFieldError('documentoFicheiroUrl'); void onUploadToDb('documento_ficheiro_url', url); }}
              ...
              <div className="space-y-2">
                ...
                <DocumentUploader
                  folder="documento-identificacao" currentUrl={documentoIdentificacaoVersoUrl}
                  onUpload={(url) => { setDocumentoIdentificacaoVersoUrl(url); clearFieldError('documentoIdentificacaoVersoUrl'); void onUploadToDb('documento_identificacao_verso_url', url); }}
                  accept="application/pdf,image/jpeg,image/png"
                />
      ...
      <Card className="border-border overflow-hidden">
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            <Label htmlFor="cartaConducao">Número da Carta <span className="text-red-500">*</span></Label>
            <Input
              id="cartaConducao" value={cartaConducao}
              onChange={(e) => { setCartaConducao(e.target.value.toUpperCase()); clearFieldError('cartaConducao'); }}
              onBlur={() => {
                if (cartaConducao) {
          ...
          <div className="space-y-2">
            <Label htmlFor="cartaValidade">Data de Validade <span className="text-red-500">*</span></Label>
            <Input
              id="cartaValidade" type="date" value={cartaValidade}
              onChange={(e) => { setCartaValidade(e.target.value); clearFieldError('cartaValidade'); }}
            ...
            <div className="flex flex-wrap gap-2">
              {CATEGORIAS_CARTA.map((cat) => (
                <div key={cat} className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor={`cat-${cat}`} className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-foreground">
                    {cat}
                  </label>
                </div>
              ))}
          ...
          <div className="space-y-2 sm:col-span-2">
            <Label>Upload da Carta de Condução <span className="text-red-500">*</span></Label>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <span className="text-xs text-muted-foreground block mb-1">Frente</span>
                <DocumentUploader
                  folder="carta-conducao" currentUrl={cartaFicheiroUrl}
                  onUpload={(url) => { setCartaFicheiroUrl(url); clearFieldError('cartaFicheiroUrl'); void onUploadToDb('carta_ficheiro_url', url); }}
                  accept="application/pdf,image/jpeg,image/png"
                />
              ...
              <div className="space-y-2">
                <span className="text-xs text-muted-foreground block mb-1">Verso</span>
                <DocumentUploader
                  folder="carta-conducao" currentUrl={cartaConducaoVersoUrl}
                  onUpload={(url) => { setCartaConducaoVersoUrl(url); clearFieldError('cartaConducaoVersoUrl'); void onUploadToDb('carta_conducao_verso_url', url); }}
                  accept="application/pdf,image/jpeg,image/png"
                />
