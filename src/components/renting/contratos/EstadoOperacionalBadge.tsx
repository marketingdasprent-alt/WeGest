...
const STYLES: Record<ContratoEstadoOperacional, string> = {
  ...
  fechado: 'border-emerald-500/40 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300',
  cancelado: 'border-red-500/40 bg-red-500/10 text-red-700 dark:text-red-300',
  // Legado: nada escreve 'devolvido' desde 20260820150200. Ver
  // CONTRATO_ESTADO_OP_LABELS — se sobrar alguma linha antiga, lê-se
  // "Fechado" com o mesmo aspecto.
