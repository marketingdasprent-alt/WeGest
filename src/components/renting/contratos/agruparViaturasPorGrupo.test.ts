...
/**
 * Selector de viatura no contrato (troca/upgrade/downgrade) não distinguia
 * grupo tarifário — o gestor via todas as viaturas misturadas. Esta função
 * separa a lista em "mesmo grupo" (mostrado primeiro/sempre) e "outros
 * grupos" (atrás de um toggle na UI), sem nunca bloquear — grupo
 * desconhecido/null cai em "outros grupos".
 */
describe('agruparViaturasPorGrupo', () => {
  ...
  it('separa viaturas do mesmo grupo da actual', () => {
  ...
  it('trata grupo null da viatura actual como "sem correspondência" — tudo em outros grupos', () => {
  ...
  it('viatura candidata com grupo null vai para outros grupos mesmo se a actual tiver grupo', () => {
