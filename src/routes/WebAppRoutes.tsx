  ...
  return (
    <>
      ...
      <Suspense fallback={<PageLoader />}>
        {/*
          A fronteira fica DENTRO do Suspense e por FORA das rotas: um erro numa
          página não derruba o menu lateral nem a navegação, e o `resetKey` com o
          pathname faz o erro limpar-se ao mudar de ecrã.
        */}
        <RouteErrorBoundary>
          <Routes>
